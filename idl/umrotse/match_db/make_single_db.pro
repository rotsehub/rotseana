pro make_single_db,dbname,actual_path,makelink=makelink,noprompt=noprompt

if n_params() eq 0 then begin
    print,'syntax - make_single_db,dbname, actual_path, makelink=makelink'
...
; Move database to actual location and create link
