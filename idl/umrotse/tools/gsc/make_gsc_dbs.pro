pro make_gsc_dbs, basename, actual_path, dbd_proto, makelinks=makelinks, noprompt=noprompt


if n_params() eq 0 then begin
   print, 'syntax - make_gsc_dbs, basename, actual_path, dbd_proto, makelinks=makelinks'
   return
endif
...
for i = bottom_id, (2*bottom_id - 1l) do begin
   ...
   printf,wlun,''
   printf,wlun,'#title'
   printf,wlun,'GSC 1.2 Database '+dbname
   printf,wlun,''
   ...
   make_single_gsc_db,dbname,actual_path,makelink=makelinks,noprompt=noprompt
