pro getpsf_rotse,image,xc,yc,apmag,sky,ronois,phpadu, gauss,psf,idpsf,psfrad, $
            fitrad,psfname, DEBUG = debug,weightim=weightim
;+
; NAME:
;	GETPSF
; PURPOSE:
...
; this star.
 ...
 pkfit_rotse, f, scale, x, y, sky[istar], fitrad, ronois, phpadu, $
		gauss, psf, errmag, chi, sharp, niter, DEBUG = debug, weightim=weightim
