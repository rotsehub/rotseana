pro pkfit_rotse,f,scale,x,y,sky,radius,ronois,phpadu,gauss,psf, $
                errmag,chi,sharp,niter, DEBUG= debug,weightim=weightim
;+
; NAME:
;	PKFIT
; PURPOSE:
...
BIGLOOP:  		        ;Begin the big least-squares loop
 ...
 if (n_elements(weightim) ne 0) then begin
     wsub=weightim[ixlo:ixhi,iylo:iyhi]
     wsub=wsub[good]
 endif
