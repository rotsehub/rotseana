pro rphot_substar,image,x,y,mag,id,psfname,VERBOSE = verbose $   ;Subtract scaled PSF stars
...
;-
 ...
 if not keyword_set(psf) and N_elements(psfname) NE 1 then begin
     psfname = ''
 ...
 if not keyword_set(psf) then psf = readfits(psfname, hpsf)
