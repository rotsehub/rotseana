pro make_usno_dbs, basename, actual_path, dbd_proto, makelinks=makelinks,noprompt=noprompt


if n_params() eq 0 then begin
   print, 'syntax - make_usno_dbs, basename, actual_path, dbd_proto, makelinks=makelinks'
   return
endif
...
ind = long((!usno_db_leaf_depth + 1) * 2 + 1)
bottom_id = 2l^ind
...
for i = bottom_id, (2*bottom_id - 1l) do begin
   ...
   printf,wlun,''
   printf,wlun,'#title'
   printf,wlun,'USNO 15th Magnitude Database '+dbname
   printf,wlun,''
   ...
   make_single_usno_db,dbname,actual_path,makelink=makelinks,noprompt=noprompt
